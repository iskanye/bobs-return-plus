...
<tileset version="1.9" tiledversion="1.9.2" name="0_TimeTravel_DecorOther" tilewidth="32" tileheight="32" tilecount="100" columns="10">
 <image source="../0_TimeTravel_DecorOther.png" width="320" height="320"/>
 <tile id="7">
  <animation>

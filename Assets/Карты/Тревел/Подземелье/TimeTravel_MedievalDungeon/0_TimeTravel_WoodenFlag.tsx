...
<tileset version="1.9" tiledversion="1.9.0" name="0_TimeTravel_WoodenFlag" tilewidth="32" tileheight="32" tilecount="20" columns="4">
 <image source="../0_TimeTravel_WoodenFlag.png" width="128" height="160"/>
 <tile id="0">
  <animation>
